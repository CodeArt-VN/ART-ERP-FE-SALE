...
export class SaleOrderMobileDetailPage extends PageBase {
	...
	saveChange() {
		...
		if (
			...
			((this.pageConfig.canChangeTypeOfReviewOrder || this.pageConfig.canChangeTypeOfReviewOrder || this.pageConfig.canUseDiscountFromSalesman) && this.item.IDStatus == 103)
		) {
